export const FETCH_DEVICES = 'CONNECT_DEVICE';
export const FETCH_DEVICES_SUCCESS = 'CONNECT_DEVICE_SUCCESS';
export const FETCH_DEVICES_FAILURE = 'CONNECT_DEVICE_FAILURE';
